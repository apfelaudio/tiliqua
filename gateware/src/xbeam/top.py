...
class XbeamSoc(Elaboratable):
    def __init__(self, clock_frequency, dvi_timings):
        ...
        firmware = get_mem_data("src/xbeam/fw/firmware.bin",
...
if __name__ == "__main__":
    ...
    design = XbeamSoc(clock_frequency=int(60e6), dvi_timings=DVI_TIMINGS["720x720p60_square"])
