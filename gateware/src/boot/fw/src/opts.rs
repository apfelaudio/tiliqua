        ...
        Options {
            ...
            boot: BootOptions {
                ...
                bitstream0: NumOption{
                    name: String::from_str("xbeam").unwrap(),
                    value: 0,
                    step: 0,
                    min: 0,
                    max: 8,
                ...
                bitstream1: NumOption{
                    name: String::from_str("polysyn").unwrap(),
                    value: 1,
                    step: 0,
                    min: 0,
                    max: 8,
                ...
                bitstream2: NumOption{
                    name: String::from_str("sidula").unwrap(),
                    value: 2,
                    step: 0,
                    min: 0,
                    max: 8,
                ...
                bitstream3: NumOption{
                    name: String::from_str("usb-sound").unwrap(),
                    value: 3,
                    step: 0,
                    min: 0,
                    max: 8,
                ...
                bitstream5: NumOption{
                    name: String::from_str("diffuser").unwrap(),
                    value: 5,
                    step: 0,
                    min: 0,
                    max: 8,
                ...
                bitstream6: NumOption{
                    name: String::from_str("selftest").unwrap(),
                    value: 6,
                    step: 0,
                    min: 0,
                    max: 8,
                ...
                bitstream7: NumOption{
                    name: String::from_str("xbeam-hd").unwrap(),
                    value: 7,
                    step: 0,
                    min: 0,
                    max: 8,
